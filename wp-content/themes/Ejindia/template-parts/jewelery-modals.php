...
<el-dialog>
    <dialog id="dialog" aria-labelledby="dialog-title" class="fixed inset-0 size-auto max-h-none max-w-none overflow-y-auto bg-transparent backdrop:bg-transparent">
        ...
        <div tabindex="0" class="flex min-h-full items-end justify-center p-4 text-center focus:outline-none sm:items-center sm:p-0">
            <el-dialog-panel class="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl outline -outline-offset-1 outline-white/10 transition-all data-closed:translate-y-4 data-closed:opacity-0 data-enter:duration-300 data-enter:ease-out data-leave:duration-200 data-leave:ease-in sm:my-8 sm:w-full sm:max-w-lg data-closed:sm:translate-y-0 data-closed:sm:scale-95 p-5">

                <button type="button" command="close" commandfor="dialog" class="absolute top-1 right-1 border z-50 cursor-pointer bg-gray-500 px-2  rounded-full">X</button>

                <div class="px-5">
                    <?php echo do_shortcode('[wpforms id="1935"]') ?>
                </div>

                <div class="flex items-center gap-4">
                    <div class="h-[0.5px] bg-gray-800 w-full"></div>
                    or
                    <div class="h-[0.5px] bg-gray-800 w-full"></div>
                </div>

                <div class="text-center py-4">
                    <p>Reach us at: <a href="mailto:info@ejindia.com">info@ejindia.com</a></p>

                    <p>Call us at: <a href="tel:+91 422 4222200">+91 422 4222200</a></p>
                </div>
            </el-dialog-panel>
        </div>
    </dialog>
