...
$goldJewels = array(
    array(
        'image' => 'http://ea.brightbridge.co/wp-content/uploads/2026/07/sliver-2.jpg',
        'name' => 'BAND',
    ),
    array(
        'image' => 'http://ea.brightbridge.co/wp-content/uploads/2026/07/sliver-6.jpg',
        'name' => 'IDOL',
    ),
    array(
        'image' => 'http://ea.brightbridge.co/wp-content/uploads/2026/07/sliver-7.jpg',
        'name' => 'JEWELLERY',
    ),
    array(
        'image' => 'http://ea.brightbridge.co/wp-content/uploads/2026/07/sliver-1.jpg',
        'name' => 'PAYAL',
    ),
    array(
        'image' => 'http://ea.brightbridge.co/wp-content/uploads/2026/07/sliver-4.jpg',
        'name' => 'SOLID IDOL',
    ),
    array(
        'image' => 'http://ea.brightbridge.co/wp-content/uploads/2026/07/sliver-5.jpg',
        'name' => 'UTENSIL',
    ),
);
?>
...
<div class="w-full overflow-hidden" style="max-height: 450px;">
    <video width="100%" autoplay muted loop playsinline style="display: block; object-fit: cover; object-position: center; height: 450px;">
        <source src="http://ea.brightbridge.co/wp-content/uploads/2026/07/silver-videos.mp4" type="video/mp4">
...
<section class="py-12 bg-[#fffdfc]">
    <div class="w-full xl:max-w-[1040px] mx-auto px-4 mb-5">
        ...
        <img src="http://ea.brightbridge.co/wp-content/uploads/2026/07/sliver-3.jpg" alt="" class="mx-auto">
