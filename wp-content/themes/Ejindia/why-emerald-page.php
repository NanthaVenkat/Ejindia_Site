<?php
/*
Template Name: Why Emerald
*/
get_header();
?>

<section class="py-12 bg-white">
    <div class="flex items-center justify-center h-[520px] p-4">
        <h4 class="uppercase text-[#555555] text-5xl font-medium lg:leading-loose text-center">YOU DREAM IT, WE MAKE IT.
        </h4>
    </div>
    ...
    <div class="w-full xl:max-w-[1020px] mx-auto px-4 space-y-8 text-white uppercase font-medium text-xl text-center">
        ...
        <div class="grid sm:grid-cols-2 md:grid-cols-3 gap-8">
            ...
            <a href="http://localhost/Ejindia_Site/discover/mission-vission/"
                ...
                <p class="absolute pointer-none top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">Customization
                </p>
            </a>
            <div class="space-y-4">
                <a href="http://localhost/Ejindia_Site/discover/mission-vission/"
                    ...
                    <p class="absolute pointer-none top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">Quality
                    </p>
                </a>
                ...
                <a href="http://localhost/Ejindia_Site/discover/mission-vission/"
                    ...
                    <p class="absolute pointer-none top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">Infrastructure
                    </p>
                </a>
            </div>
            <a href="http://localhost/Ejindia_Site/discover/mission-vission/"
                ...
                <p class="absolute pointer-none top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">Certification
                </p>
            </a>
        </div>
